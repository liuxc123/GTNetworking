...
NSString *const GTRequestValidationErrorDomain = @"com.liuxc.request.validation";

@interface GTBaseRequest ()
...
- (void)setCompletionBlockWithSuccess:(GTRequestCompletionBlock)success
                              failure:(GTRequestCompletionBlock)failure {
...
- (void)start {
    ...
    [[GTNetworkAgent sharedAgent] addRequest:self];
}

- (void)stop {
    [self toggleAccessoriesWillStopCallBack];
    self.delegate = nil;
    [[GTNetworkAgent sharedAgent] cancelRequest:self];
    [self toggleAccessoriesDidStopCallBack];
}

- (void)startWithCompletionBlockWithSuccess:(GTRequestCompletionBlock)success
                                    failure:(GTRequestCompletionBlock)failure {
